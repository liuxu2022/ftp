...
public class DimensionValueConverter {
  ...
  public static DimensionValue convert(DimensionValueEntity entity){
    ...
    dimensionValue.setLeafOnlyFlag(entity.getLeafOnlyFlag());
    dimensionValue.setEnabledFlag(entity.getEnabledFlag());
  ...
  public static DimensionValueEntity convert(DimensionValue dimensionValue){
    ...
    entity.setLeafOnlyFlag(dimensionValue.getLeafOnlyFlag());
    entity.setEnabledFlag(dimensionValue.getEnabledFlag());
    return entity;
  }
