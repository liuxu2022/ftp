...
@Entity
@Table(name="DimensionHierarchValue")
public class DimensionHierarchValueEntity {

  @Id
  @GeneratedValue(generator = "dimension_hierarch_value_id", strategy = GenerationType.SEQUENCE)
  @SequenceGenerator(name = "dimension_hierarch_value_id", sequenceName = "seq_dimension_hierarch_value_id", allocationSize = 1)
  private Long id;
  ...
  public DimensionHierarchValueEntity(Long id, String dimensionHierarchyId,
  ...
  public DimensionHierarchValueEntity() {
  }
  ...
  public boolean equals(Object o) {
    ...
    DimensionHierarchValueEntity that = (DimensionHierarchValueEntity) o;
